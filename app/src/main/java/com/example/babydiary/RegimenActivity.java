...
import com.example.babydiary.regimen.MainAdapter;
import com.example.babydiary.regimen.MainData;
import com.example.babydiary.regimen.RoomDB;
...
//        setContentView(R.layout.);
        ...
        mainAdapter=new MainAdapter(dataList, RegimenActivity.this);
        //set adapter
        ...
        btAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sText.equals("")){
                    ...
                    dataList.clear();
                    Toast.makeText(RegimenActivity.this,"Successfully added!",Toast.LENGTH_LONG).show();

                    dataList.addAll(database.mainDao().getAll());
                    mainAdapter.notifyDataSetChanged();

                }else{
                    builder= new AlertDialog.Builder(RegimenActivity.this);
